...
UPDATE kor_web SET kor_web_logo = #{korWebLogo}, kor_web_title = #{korWebTitle}, kor_web_menus = #{korWebMenus}, kor_web_copyright = #{korWebCopyright}, kor_web_term text = #{korWebTerm};
